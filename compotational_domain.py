...
# 2. compute
values *= 2  # numpy operates on the level of unboxed variables, i.e. int64 in C. So, it can parallelize it optimally
...
class Product:
    def __init__(self, *components):
        ...
        self.components = DataFrame(
            [[c.manufacturer, c.resistance] for c in components],
            columns=["manufacturer", "resistance"],
            index=[c.number for c in components],
        )
